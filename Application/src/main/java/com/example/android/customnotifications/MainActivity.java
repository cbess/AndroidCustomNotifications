...
public class MainActivity extends Activity {
    ...
    private void createNotification() {
        ...
        clickIntent.setAction("small-button-click");
        ...
        clickIntent = new Intent(this, AppWidgetProvider.class);
        clickIntent.setAction("expanded-button-click");
        pendingIntent = PendingIntent.getBroadcast(this, 0, clickIntent, 0);
        contentView.setOnClickPendingIntent(R.id.button, pendingIntent);
